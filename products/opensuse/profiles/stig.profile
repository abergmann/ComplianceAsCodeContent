...
title: 'openSUSE Profile based on DISA STIG for SUSE Linux Enterprise 15'

description: |-
    This openSUSE profile contains configuration checks that align
    to the DISA STIG for SUSE Linux Enterprise 15 V1R4.
